 ...
 * @LastEditTime: 2022-04-08 19:42:13
...
<template>
  <div class="abox">
    ...
    <ul class="bigBox">
      ...
      <button @click="change(dataTime)">筛选</button>
    </ul>
    <!-- //开局选项 -->
    <div class="list">
...
name:"Publish",
  ...
  methods: {
    ...
    change(id) {
      this.axios({
        url: "https://apis.netstart.cn/yunyuedu/rank/publish/list/data.json?sortType="+id+"&type=sell",
        method: "get",
        params: {},
      })
        .then((result) => {
